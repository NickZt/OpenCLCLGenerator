...
public class OpenCLCLGenerator extends AnAction {
    ...
    static final public String DEFAULT_PREFIX_CL = "CL_";
    static final public String DEFAULT_POSTFIX_SIZE = "_SIZE";
...
//        }
        clHeaderWriter.write("sizeof(" + PREFIX_CL + clFileNameSB + ") / sizeof(const char *);");//textCounter
        clHeaderWriter.newLine();
        clHeaderWriter.newLine();
        clHeaderWriter.newLine();
        clHeaderWriter.flush();
